<template>
  ...
  <Transition name="ws-panel">
    <div v-if="entity" class="info-panel" role="complementary" aria-label="实体详情" tabindex="-1" @keydown="onKeyDown" :style="{ width: infoResizable.width.value + 'px' }">
...
const infoResizable = useResizable({ panelId: 'detail-info', defaultWidth: 340, minWidth: 240, side: 'left' })
