...
resp = requests.post('https://sui-xiang.com/v1/images/generations',
    headers={'Authorization':'Bearer Link_zu7jkkkiEIl7po2Q6dMH0k6yRyhv3i3Wjp08ogULSG','Content-Type':'application/json'},
    json={'model':'gpt-image-2',
        'prompt':'Cinematic movie poster, vertical portrait, ultra-detailed. Futuristic sci-fi landscape with Eastern aesthetics. Majestic mountains in clouds, glowing river like liquid light. Deep space stars. Color deep navy black silver-white cold neon cyan. Minimalist. Far distant floating spacecraft and city skyline through mist. Cinematic volumetric fog. Bottom center text SHANHAI FLEET in Chinese minimalist futuristic font silver glow. Movie poster.',
